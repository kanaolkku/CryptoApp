...
import { checkDownwardTrend, checkHighestTradingVolume, highestProfitInRange, fetchDataFromApi } from '../services/cryptoService'
...
const CryptoCalculator = () => {
  ...
  const [profit, setProfit] = useState({ endDate: "", endPrice: "", profit: "", startDate: "", startPrice: "" });
  ...
  const getCoinData = async () => {
    ...
    if (data) {
      ...
      setProfit(profitObj)
      setTradingVolume(`${highestTradingVolume.amount} € on ${highestTradingVolume.date}`)
      ...
      <div className="calculator">
        ...
        <div className="calc-container">
          ...
          <div className="result-dates-container">
            <span className="date-item">{dates.date1}</span><span className="separator">&#8211;</span>
